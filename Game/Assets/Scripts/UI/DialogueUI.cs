...
namespace Nidavellir.FoxIt.UI
{
    ...
    {
        private static readonly WaitForSeconds s_fadeInTextDelay = new WaitForSeconds(0.1f);
        ...
        public bool IsCurrentlyFadingTextIn()
        {
            return this.m_fadeInTextCoroutine != null;
        }
        ...
        public void ShowPlayerChoices(IEnumerable<DialogueNode> playerChoices)
        {
            ...
            foreach (var playerChoice in playerChoices)
            {
                ...
                newBtn.ChoiceButton.onClick.AddListener(() => { this.m_playerMadeChoice?.Invoke(this, new PlayerMadeChoiceEvent(playerChoice.Id)); });
            }
        }
        ...
        private IEnumerator FadeInText(string text)
        {
            ...
            {
                yield return s_fadeInTextDelay;
